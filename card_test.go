...
func TestSearchResultHandling(t *testing.T) {
	tables := []struct {
		...
		{"test_data/searchtest-sevenresults.json", "[Autochthon Wurm], [B.F.M. (Big Furry Monster)], [B.F.M. (Big Furry Monster)], [Draco], [Emrakul, the Aeons Torn], [Gleemax], [Mox Lotus]", false},
