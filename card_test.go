...
func TestPrintCardForIRC(t *testing.T) {
	tables := []struct {
		...
		{"Dryad Arbor", "\x02Dryad Arbor\x0F · Land Creature — Forest Dryad · 1/1 · [Green] · \x1D(Dryad Arbor isn't a spell, it's affected by summoning sickness, and it has \"{T}: Add {G}.\")\x0F · FUT-U · Vin,Leg,Mod"},
