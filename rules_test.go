...
func TestBetterGetRule(t *testing.T) {
	tables := []struct {
		...
		{"702.53", "<b>702.53a.</b> Bloodthirst is a static ability. \"Bloodthirst N\" means \"If an opponent was dealt damage this turn, this permanent enters the battlefield with N +1/+1 counters on it.\""},
		{"702.22", "<b>702.22a.</b> Rampage is a triggered ability. \"Rampage N\" means \"Whenever this creature becomes blocked, it gets +N/+N until end of turn for each creature blocking it beyond the first.\" (See rule 509, \"Declare Blockers Step.\")"},
		{"def Rampage", "<b>Rampage</b>: A keyword ability that can make a creature better in combat. See rule 702.22, \"Rampage.\"\n<b>702.22a.</b> Rampage is a triggered ability. \"Rampage N\" means \"Whenever this creature becomes blocked, it gets +N/+N until end of turn for each creature blocking it beyond the first.\" (See rule 509, \"Declare Blockers Step.\")"},
		{"702.30", "<b>702.30b.</b> A creature with horsemanship can't be blocked by creatures without horsemanship. A creature with horsemanship can block a creature with or without horsemanship. (See rule 509, \"Declare Blockers Step.\")"},
		{"702.3.", "<b>702.3b.</b> A creature with defender can't attack."},
		{"702.44.", "<b>702.44a.</b> Bushido is a triggered ability. \"Bushido N\" means \"Whenever this creature blocks or becomes blocked, it gets +N/+N until end of turn.\" (See rule 509, \"Declare Blockers Step.\")"},
		{"def Bushido", "<b>Bushido</b>: A keyword ability that can make a creature better in combat. See rule 702.44, \"Bushido.\"\n<b>702.44a.</b> Bushido is a triggered ability. \"Bushido N\" means \"Whenever this creature blocks or becomes blocked, it gets +N/+N until end of turn.\" (See rule 509, \"Declare Blockers Step.\")"},
		...
		{"702.56", "<b>702.56b.</b> A forecast ability may be activated only during the upkeep step of the card's owner and only once each turn. The controller of the forecast ability reveals the card with that ability from their hand as the ability is activated. That player plays with that card revealed in their hand until it leaves the player's hand or until a step or phase that isn't an upkeep step begins, whichever comes first."},
		{"def Forecast", "<b>Forecast</b>: A keyword ability that allows an activated ability to be activated from a player's hand. See rule 702.56, \"Forecast.\"\n<b>702.56b.</b> A forecast ability may be activated only during the upkeep step of the card's owner and only once each turn. The controller of the forecast ability reveals the card with that ability from their hand as the ability is activated. That player plays with that card revealed in their hand until it leaves the player's hand or until a step or phase that isn't an upkeep step begins, whichever comes first."},
		...
		{"define mana abilities", "<b>605.1a.</b> An activated ability is a mana ability if it meets all of the following criteria: it doesn't require a target (see rule 115.6), it could add mana to a player's mana pool when it resolves, and it's not a loyalty ability. (See rule 606, \"Loyalty Abilities.\")"},
	}
...
func TestGetRule(t *testing.T) {
	...
	tables := []struct {
		...
		{"rule 701.28", "<b>701.28a.</b> Certain spells and abilities can detain a permanent. Until the next turn of the controller of that spell or ability, that permanent can't attack or block and its activated abilities can't be activated."},
		{"702.21a", "<b>702.21a.</b> Banding is a static ability that modifies the rules for combat."},
		{"702.21", "<b>702.21c.</b> As a player declares attackers, they may declare that one or more attacking creatures with banding and up to one attacking creature without banding (even if it has \"bands with other\") are all in a \"band.\" They may also declare that one or more attacking [quality] creatures with \"bands with other [quality]\" and any number of other attacking [quality] creatures are all in a band. A player may declare as many attacking bands as they want, but each creature may be a member of only one of them. (Defending players can't declare bands but may use banding in a different way; see rule 702.21j.)"},
		...
		{"def Absorb", "<b>Absorb</b>: A keyword ability that prevents damage. See rule 702.63, \"Absorb.\"\n<b>702.63a.</b> Absorb is a static ability. \"Absorb N\" means \"If a source would deal damage to this creature, prevent N of that damage.\""},
		{"define Absorb", "<b>Absorb</b>: A keyword ability that prevents damage. See rule 702.63, \"Absorb.\"\n<b>702.63a.</b> Absorb is a static ability. \"Absorb N\" means \"If a source would deal damage to this creature, prevent N of that damage.\""},
		{"rule Absorb", "<b>Absorb</b>: A keyword ability that prevents damage. See rule 702.63, \"Absorb.\"\n<b>702.63a.</b> Absorb is a static ability. \"Absorb N\" means \"If a source would deal damage to this creature, prevent N of that damage.\""},
		...
		{"define detain", "<b>Detain</b>: A keyword action that temporarily stops a permanent from attacking, blocking, or having its activated abilities activated. See rule 701.28, \"Detain.\"\n<b>701.28a.</b> Certain spells and abilities can detain a permanent. Until the next turn of the controller of that spell or ability, that permanent can't attack or block and its activated abilities can't be activated."},
...
func TestRules(t *testing.T) {
	...
	tables := []struct {
		...
		{"absorb", []string{"<b>Absorb</b>: A keyword ability that prevents damage. See rule 702.63, \"Absorb.\""}},
